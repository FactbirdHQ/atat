...
// Consumers
pub type ComConsumer = Consumer<'static, ComItem, COM_CAPACITY>;
pub type ResConsumer<const BUF_LEN: usize> = Consumer<'static, ResItem<BUF_LEN>, RES_CAPACITY>;
pub type UrcConsumer<const BUF_LEN: usize, const URC_CAPACITY: usize> =
    Consumer<'static, UrcItem<BUF_LEN>, URC_CAPACITY>;

// Producers
pub type ComProducer = Producer<'static, ComItem, COM_CAPACITY>;
pub type ResProducer<const BUF_LEN: usize> = Producer<'static, ResItem<BUF_LEN>, RES_CAPACITY>;
pub type UrcProducer<const BUF_LEN: usize, const URC_CAPACITY: usize> =
    Producer<'static, UrcItem<BUF_LEN>, URC_CAPACITY>;

// Queues
pub type ComQueue = Queue<ComItem, COM_CAPACITY>;
pub type ResQueue<const BUF_LEN: usize> = Queue<ResItem<BUF_LEN>, RES_CAPACITY>;
